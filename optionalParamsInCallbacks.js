...
myForEach([1, 2, 3], function (elem, index) { return console.log(index.toFixed()); });
/*
    SCENARIO 2 CONT'D
...
*/
myForEach([1, 2, 3], function (elem) { return console.log(elem); });
myForEach([1, 2, 3], function (elem, index) { return console.log(elem, index); });
